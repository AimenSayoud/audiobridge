...
class PairingTest {
    ...
    fun parsesWhatTheServerEncodes() {
        val uri = "tethertone://p?h=127.0.0.1&h=10.8.22.255&p=45678&t=152NF7gTPqUCj3P8BbcJ_Q" +
    ...
    fun hostOrderIsPreserved() {
        ...
        val info = Pairing.parse("tethertone://p?h=127.0.0.1&h=192.168.1.5&p=1&t=x")!!
    ...
    fun rejectsRubbish() {
        ...
        assertNull(Pairing.parse("tethertone://p?"))
        assertNull(Pairing.parse("tethertone://p?h=1.2.3.4&p=99999&t=x"))
