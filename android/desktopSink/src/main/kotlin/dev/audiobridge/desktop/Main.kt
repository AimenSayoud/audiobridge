package dev.audiobridge.desktop

import dev.audiobridge.shared.BridgeClient
 ...
 *
 *   ./gradlew :desktopSink:run --args="audiobridge://p?..."
...
fun main(args: Array<String>) = runBlocking {
    ...
    val info: PairingInfo = uri?.let(Pairing::parse) ?: run {
        val tokenFile = File(System.getProperty("user.home"), ".audiobridge/token")
